        ...
        <nav id='mnav' class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="./exams.php"><i class="fas fa-edit"></i><span>Sınavlar</span></a></li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="container-fluid text-left mb-4">
                        ...
                        ?>
                        <h3 class="text-dark mb-0">Sınavlar</h3>
                    </div>
                        ...
                        <div class="col-lg-5 col-xl-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="text-primary font-weight-bold m-0">Sınav Oluştur</h6>
                                </div>
                                <div class="card-body">
